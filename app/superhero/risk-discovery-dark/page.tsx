        ...
        <div className="flex-1 flex flex-col overflow-y-auto">
          ...
          <div className="flex-1 px-8 py-6">
            ...
            <div className="flex items-center gap-2 text-[12px] text-[#6e7681] mb-4">
              <span className="hover:text-[#58a6ff] cursor-pointer">AI Risk Essentials</span>
              <span>›</span>
              <span className="hover:text-[#58a6ff] cursor-pointer">Risk Identification</span>
              <span>›</span>
            </div>

            {/* Title */}
            <div className="flex items-center gap-3 mb-2">
              <Link href="/superhero/boards-home" className="text-[#8b949e] hover:text-[#c9d1d9]">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="15 18 9 12 15 6" /></svg>
              </Link>
              <h1 className="text-xl font-bold text-[#f0f6fc]">AI risk discovery</h1>
            </div>
            <p className="text-sm text-[#8b949e] mb-6 ml-8">
