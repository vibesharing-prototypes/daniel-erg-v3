...
const CONTEXT_PACKETS: ContextPacketFolder[] = [
  { id: "cp1", riskLabel: "Taiwan Strait — Supply Chain", severity: "Critical", fileCount: 8, lastModified: "today, 2:49 PM", href: "/light/superhero/data-room/taiwan-strait" },
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="border-b-2 border-[#0ea5e9]/40 bg-[#e0f2fe] flex-shrink-0">
        ...
        <div className="px-4 py-2 flex items-center justify-between flex-wrap gap-2">
          <div className="flex items-center gap-3">
            ...
            <Link href="/light/superhero/context-packet" className="text-xs font-medium text-[#0369a1] hover:underline">
              ← Context Packet
            </Link>
          </div>
      ...
      <div className="flex-1 flex overflow-hidden min-h-0">
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden bg-white">
          ...
          <div className="px-6 pt-3 pb-4 flex items-center justify-between flex-shrink-0">
            <div className="flex items-center gap-3">
              <Link href="/light/superhero/context-packet" className="text-[#374151] hover:text-[#111827]">
      ...
      <StakeholderFooter label="Continue as General Counsel to advance the workflow">
        <Link href="/light/superhero/context-packet" className="text-sm text-[#6b7280] hover:text-[#374151]">
