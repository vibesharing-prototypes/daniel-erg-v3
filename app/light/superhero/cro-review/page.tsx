...
function CroReviewContent() {
  ...
  const handleContinueAsGC = () => {
    ...
    router.push(`/light/superhero/writer?risk=${riskId}&owner=${ownerId}`);
  };
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden min-h-0">
        ...
        <div className="mx-auto max-w-4xl px-4 py-6">
          <h1 className="text-xl font-semibold text-[#111827] mb-2">Risk Owner Investigation Review</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-[#e5e7eb] bg-[#f9fafb] p-5">
              <h2 className="text-sm font-medium text-[#9ca3af] uppercase tracking-wider mb-2">Risk</h2>
              <p className="text-base font-semibold text-[#111827]">{riskName}</p>
            </div>

            {/* Owner info */}
            <div className="rounded-xl border border-[#e5e7eb] bg-[#f9fafb] p-5">
              <h2 className="text-sm font-medium text-[#9ca3af] uppercase tracking-wider mb-3">Investigated by</h2>
              <div className="flex items-center gap-4">
                ...
                />
                <div>
                  <p className="text-base font-semibold text-[#111827]">{owner.name}</p>
                  <p className="text-sm text-[#6b7280]">{owner.title}</p>
                </div>
              </div>
            </div>
            ...
            {/* Domain context */}
            <div className="rounded-xl border border-[#e5e7eb] bg-[#f9fafb] p-5">
              <h2 className="text-sm font-medium text-[#9ca3af] uppercase tracking-wider mb-2">Additional context from Risk Owner</h2>
            ...
            {/* Severity validation */}
            <div className="rounded-xl border border-[#e5e7eb] bg-[#f9fafb] p-5">
              <h2 className="text-sm font-medium text-[#9ca3af] uppercase tracking-wider mb-2">Severity assessment</h2>
            ...
            <div className="rounded-xl border border-[#e5e7eb] bg-[#f9fafb] p-5">
              <h2 className="text-sm font-medium text-[#9ca3af] uppercase tracking-wider mb-2">Disclosure recommendation</h2>
              <p className="text-sm text-[#111827]">
            ...
            <div className="rounded-xl border border-[#3b82f6]/30 bg-[#3b82f6]/5 p-5">
              <h2 className="text-sm font-medium text-[#2563eb] uppercase tracking-wider mb-4">Your risk assessment</h2>
              <p className="text-xs text-[#6b7280] mb-4">
                Assess likelihood, impact, controls, and mitigations. This will inform the 10-K disclosure draft.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                <div>
                  <label className="block text-xs font-medium text-[#6b7280] mb-1.5">Likelihood of occurrence</label>
                  <select
                    value={likelihood}
                    onChange={(e) => setLikelihood(e.target.value)}
                    className="w-full rounded-lg border border-[#e5e7eb] bg-[#f9fafb] px-3 py-2 text-sm text-[#111827] focus:border-[#3b82f6] focus:outline-none"
                  >
                ...
                <div>
                  <label className="block text-xs font-medium text-[#6b7280] mb-1.5">Impact if it occurs</label>
                  <select
                    value={impact}
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-xs font-medium text-[#6b7280] mb-1.5">Controls in place</label>
                  <textarea
                    value={controls}
                ...
                <div>
                  <label className="block text-xs font-medium text-[#6b7280] mb-1.5">Mitigations planned or underway</label>
                  <textarea
                    value={mitigations}
            ...
            <div className="rounded-xl border border-[#e5e7eb] bg-[#f9fafb] p-5">
              <h2 className="text-sm font-medium text-[#9ca3af] uppercase tracking-wider mb-2">Additional CRO assessment</h2>
            ...
            <div className="rounded-xl border border-[#3b82f6]/30 bg-[#3b82f6]/5 p-5">
              <h2 className="text-sm font-medium text-[#2563eb] uppercase tracking-wider mb-2">Next steps</h2>
              ...
              <button
                ...
                className={cn(
                  ...
                  submitted
                    ? "bg-[#3fb950]/20 text-[#16a34a] cursor-default"
