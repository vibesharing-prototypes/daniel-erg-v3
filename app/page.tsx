...
const sections: Section[] = [
  {
    ...
    steps: [
      ...
      {
        id: "A2",
        title: "Boards Home (Near-Term Vision) (Alternate layout)",
        description: "GRC Command Center as a floating widget that expands to a compact modal overlay.",
        href: "/superhero/boards-home-modal",
        enabled: true,
      },
      {
        id: "B",
        ...
        href: "/gc-commandcenter?direct=1",
        enabled: true,
      },
      {
        id: "B2",
    ...
    steps: [
      {
        ...
        description: "Covered by the GRC Command Center — detected risks surface inline with source context from news feeds, regulatory filings, and vendor intelligence.",
        href: "/gc-commandcenter?direct=1",
        enabled: true,
      },
      {
        ...
        description: "Covered by the GRC Command Center — each risk card shows an AI-suggested owner with inline Assign / Skip actions.",
        href: "/gc-commandcenter?direct=1",
        enabled: true,
      },
    ],
